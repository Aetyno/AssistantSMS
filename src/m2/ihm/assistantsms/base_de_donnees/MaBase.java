...
public class MaBase extends SQLiteOpenHelper{
	...
	private static final String CREATE_BDD = " CREATE TABLE " + TABLE_SMS + " ( " + COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_CONTACT + " TEXT, " + COL_LOCALISATION + " TEXT, " + COL_DATE + " TEXT, " + COL_MESSAGE + " TEXT);";
